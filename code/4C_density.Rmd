...
viewpoint <- 166169213 # the viewpoint coordinate
...
ggplot(loops, aes(x=den, fill=status, colour=status,width=7, height=3 )) +
...
[4C_density results](https://github.com/mangiruben/TBXT_regulation/blob/main/code/4C_density.html)
